...
### 5. Mobile-first rehearsal / 모바일 우선 연습
...
## Product decisions that mattered / 단순한 예상질문 앱보다 중요했던 것

### 1. Fact integrity / 사실을 만들어내지 않기
...
### 2. Compression over accumulation / 암기량을 늘리지 않고 압축하기
...
### 3. Separate written labels from TTS pronunciation / 표기와 발음을 분리하기
...
### Main product surfaces / 주요 제품 화면
